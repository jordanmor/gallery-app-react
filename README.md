## A Gallery App Built With React
...
4. Create a `env.local` file in the root of the `client` folder. 
    - Ex. `/client/env.local`
    - Add your Flickr API key to the `env.local` file:
``` 
    REACT_APP_FLICKR_APIKEY=YOUR_API_KEY;
```
